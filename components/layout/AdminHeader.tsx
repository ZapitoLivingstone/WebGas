        ...
        <nav className="flex items-center justify-between py-2 h-16 relative">
          ...
          <div className="flex items-center gap-2 min-w-[120px]">
            <img
              ...
              draggable={false}
            />
            <span className="font-bold text-xl text-[#C22320] tracking-wide select-none">ADMIN</span>
          </div>

          {/* Tabs desktop (aparecen solo en XL o más) */}
          ...
          {open && (
            ...
            >
              <div className="flex justify-between items-center px-4 py-2">
                <span className="font-bold text-lg text-[#C22320]">Menú Admin</span>
                <button
              ...
              {/* Botón Volver a tienda en mobile */}
